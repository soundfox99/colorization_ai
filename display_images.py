...
def display_random_images(diretory):
    ...
    input_2_files = [filename for filename in os.listdir(input_2_dir) if os.path.isfile(os.path.join(input_2_dir, filename))]
    input_1_files = [filename for filename in os.listdir(input_1_dir) if os.path.isfile(os.path.join(input_1_dir, filename))]
